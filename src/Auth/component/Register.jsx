                    ...
                    <div className="grid grid-cols-1 md:items-stretch md:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-10">
                        <div className="flex flex-col justify-between lg:py-5">
                            <div>
                                ...
                                <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-white">Welcome to FitFusion, your one-stop destination for achieving your fitness goals and leading a healthier lifestyle. Whether you a seasoned gym-goer or just starting your fitness journey, FitFusion offers everything you need to succeed.</p>
                        ...
                        <div className="lg:pl-12">
                            <div className="overflow-hidden bg-white rounded-md">
                                <div className="p-6 sm:p-10">
                                    <h3 className="text-3xl font-semibold text-black uppercase">Register </h3>
                                    <p className="mt-4 text-base font-semibold text-gray-600 uppercase">Create Account for the platform.
</p>
                                        ...
                                        <div className="space-y-6">
                                            <div>
                                                ...
                                                <div className="mt-2.5 relative">
                                                    <input
                                                        type="text"
                                                        id="name"
                                                        placeholder="Enter your full name" name="name" onChange={e => changeUserFieldHandler(e)}
                                            ...
                                            <div>
                                                ...
                                                <div className="mt-2.5 relative">
                                                    <input
                                                        type="text"
                                                        id="email"
                                                        placeholder="Enter your email address" name="email" onChange={e => changeUserFieldHandler(e)} required
                                                        className="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:ring-orange-500 focus:border-orange-500 caret-orange-500"
                                                    />
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <input
                                                        type="password"
                                                        id="password"
                                                        placeholder="Enter your password" name="password" onChange={e => changeUserFieldHandler(e)} required
                                                        className="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:ring-orange-500 focus:border-orange-500 caret-orange-500"
                                                    />
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <button type="submit" onClick={e => onSubmitChange(e)} className="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-[#7A3E3E] border border-transparent rounded-md focus:outline-none hover:bg-orange-600 focus:bg-orange-600">
                                                   Register
                                                </button>
                                            </div>
